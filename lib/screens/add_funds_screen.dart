...
class _AddFundsScreenState extends State<AddFundsScreen> {
  ...
  Future<void> _addFunds() async {
    ...
    try {
      ...
      await HiveService.addFundsToGoal(_selectedGoal!.id, amount);
      ...
      if (updatedGoal != null) {
        ...
        await HiveService.logSavingsActivity(
          SavingsActivity(
            type: SavingsActivityType.fundsAdded,
      ...
      _showError('Failed to add funds: $e');
    } finally {
      if (mounted) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Create savings goals first to add funds',
  ...
  return Container(
    ...
    child: Column(
      children: [
        // First Row: Goal Name + Current Balance
        Row(
        ...
        // Second Row: Target + Progress (only if target exists)
  ...
  Widget _buildAddFundsButton() {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: isEnabled ? _addFunds : null,
        style: ElevatedButton.styleFrom(
          backgroundColor: isEnabled ? AppTheme.successGradient.colors[0] : Colors.grey,
          foregroundColor: Colors.white,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(AppTheme.borderRadius),
          ),
